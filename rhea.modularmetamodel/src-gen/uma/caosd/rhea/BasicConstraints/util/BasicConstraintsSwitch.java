 ...
 * @generated
 */
public class BasicConstraintsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicConstraintsPackage.BASIC_CONSTRAINT: {
			...
			case BasicConstraintsPackage.REQUIRES: {
				REQUIRES requires = (REQUIRES)theEObject;
				T result = caseREQUIRES(requires);
				if (result == null) result = caseBasicConstraint(requires);
				if (result == null) result = caseCrossTreeConstraint(requires);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicConstraintsPackage.EXCLUDES: {
				EXCLUDES excludes = (EXCLUDES)theEObject;
				T result = caseEXCLUDES(excludes);
				if (result == null) result = caseBasicConstraint(excludes);
				if (result == null) result = caseCrossTreeConstraint(excludes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
