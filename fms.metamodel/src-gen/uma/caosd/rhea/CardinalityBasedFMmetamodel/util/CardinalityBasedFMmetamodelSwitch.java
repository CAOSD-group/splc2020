 ...
 * @generated
 */
public class CardinalityBasedFMmetamodelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public CardinalityBasedFMmetamodelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CardinalityBasedFMmetamodelPackage.GROUP_FEATURE: {
...
} //CardinalityBasedFMmetamodelSwitch
